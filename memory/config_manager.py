...
def get_assistant_name() -> str:
    """Return the configured assistant name, or 'TOKYO' if not set."""
    return load_api_keys().get("assistant_name", "TOKYO") or "TOKYO"
...
def save_assistant_config(assistant_name: str, user_name: str) -> None:
    ...
    if CONFIG_FILE.exists():
        try:
            ...
            data = {}
    data["assistant_name"] = assistant_name.strip() or "TOKYO"
